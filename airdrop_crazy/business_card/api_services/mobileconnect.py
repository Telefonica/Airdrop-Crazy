...
class MobileConnect():
    ...
    def request_data(self):
        if (self.phone):
            ...
            payload = f"{{\"Redirect_URL\": \"https://safepost.luca-d3.com/mobileconnect\",\"MSISDN\": \"{self.phone}\"}}"
            headers = {
                'Content-Type': "application/json",
                'Accept': "application/json",
                'Authorization': "Basic ZTczYmY5NDgtYzdhMi00NTg4LTgzODItZjg3Y2UwMWZlZjVkOjhjMGJkMmI5LTg4MDAtNDA1Ny04NGYyLTZmNTA3NGY3ODc3Ng==",
